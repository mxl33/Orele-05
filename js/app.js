(() => {
    ...
    (() => {
        ...
        function initSliderWithViewportAutoplay(selector, options) {
            let slider = null;
            let observer = null;
            function createSlider() {
                slider = new swiper_core_Swiper(selector, {
                    ...options,
                    autoplay: {
                        ...options.autoplay,
                        disableOnInteraction: false,
            ...
            return {
                ...
                recreate: createSlider
            };
        }
        function initSliders() {
            if (document.querySelector(".assortment__slider")) initSliderWithViewportAutoplay(".assortment__slider", {
            ...
            if (document.querySelector(".recommended__slider")) initSliderWithViewportAutoplay(".recommended__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.7,
            ...
            if (document.querySelector(".principles__slider")) initSliderWithViewportAutoplay(".principles__slider", {
                ...
                pagination: {
                    ...
                    renderBullet: function(index, className) {
                        const paginationTexts = [ "прозрачно", "эталонно", "позитивно", "для вас" ];
                        return '<span class="' + className + ' principles__title heading-02">' + paginationTexts[index] + "</span>";
                    }
                },
                navigation: {
                    prevEl: ".swiper-button-prev",
        ...
        function swiperMode() {
            ...
            if (mobile.matches) {
                if (!init) {
                    init = true;
                    if (document.querySelector(".explore-blog__slider")) swipers["explore-blog"] = initSliderWithViewportAutoplay(".explore-blog__slider", {
                        modules: [ Navigation, Autoplay ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1.2,
                    ...
                    if (document.querySelector(".product__slider")) swipers["product"] = initSliderWithViewportAutoplay(".product__slider", {
                        modules: [ Navigation, Autoplay ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
            ...
            } else if ((tablet.matches || desktop.matches) && init) {
